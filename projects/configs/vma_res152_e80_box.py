...
map_classes =['Crosswalk', 'SpeedBump', 'NoParkingLine', 'Arrow', 'Diamond_marking', 'ExclusiveLaneSign', 'InvertedTriangleMarking']
arrow_attrs = ['Mergeright', 'Mergeleft', 'Turnright', 'Turnleft', 'Straight', 'Turnoff', 'Straight-Turnleft', 'Straight-Turnright', 'Turnright-Turnleft', 'Other', 'Turnoff-Turnleft', 'Turnright-Straight-Turnleft', 'Turnoff-Straight', 'Turnright-Turnoff', 'Turnright-Other-Straight-Turnleft', 'Other-Turnleft', 'No_Turnoff', 'Straight-Mergeleft', 'No_Straight-Straight']
exclusivelanesign_attrs = ['BikeLane', 'BusLane']
attrs_dict = {'Arrow':arrow_attrs, 'ExclusiveLaneSign':exclusivelanesign_attrs}
fixed_ptsnum_per_gt_line = 5 # now only support fixed_pts > 0
fixed_ptsnum_per_pred_line = 5
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        attr_head=dict(
            ...
            attr_classes=[len(arrow_attrs), len(exclusivelanesign_attrs)],
            mlp_layers=3,
            in_channels=256, 
...
dataset_type = 'SD_Driving_Box_Dataset'
data_root = 'data/sd_data/box/cropped_data'
...
data = dict(
    ...
    train=dict(
        ...
        annotation_file = 'sd_data_box_dict.json',
